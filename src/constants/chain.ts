...
export const chains = {
  [CHAIN.COSMOS]: {
    ...
    gas: {
      ...
      redelegate: '1000000',
      withdraw: '800000',
      withdrawReward: '800000',
      withdrawCommission: '800000',
      modifyWithdrawAddress: '800000',
    },
  },
  [CHAIN.PASSAGE]: {
    chainId: 'passage-2',
  ...
  [CHAIN.SIFCHAIN]: {
    ...
    fee: {
      ...
      withdraw: '0.3',
      withdrawReward: '0.3',
      withdrawCommission: '0.3',
      modifyWithdrawAddress: '0.3',
    },
    gas: {
      default: '600000',
      delegate: '600000',
  ...
  [CHAIN.CRYPTO_ORG]: {
    ...
    fee: {
      ...
      redelegate: '0.0004',
      withdraw: '0.0002',
      withdrawReward: '0.0002',
      withdrawCommission: '0.0002',
      modifyWithdrawAddress: '0.0002',
    },
    gas: {
      default: '600000',
      delegate: '600000',
  ...
  [CHAIN.MEDIBLOC]: {
    ...
    fee: {
      ...
      withdraw: '3',
      withdrawReward: '3',
      withdrawCommission: '3',
      modifyWithdrawAddress: '3',
    },
    gas: {
      default: '600000',
      delegate: '600000',
  ...
  [CHAIN.EMONEY]: {
    ...
    fee: {
      ...
      withdraw: '0.75',
      withdrawReward: '0.75',
      withdrawCommission: '0.75',
      modifyWithdrawAddress: '0.75',
    },
    gas: {
      default: '600000',
      delegate: '600000',
  ...
  [CHAIN.JUNO]: {
    ...
    fee: {
      ...
      withdraw: '0.04',
      withdrawReward: '0.04',
      withdrawCommission: '0.04',
      modifyWithdrawAddress: '0.04',
    },
    gas: {
      default: '400000',
      delegate: '400000',
  ...
  [CHAIN.OMNIFLIX]: {
    ...
    fee: {
      ...
      redelegate: '0.003',
      withdraw: '0.002',
      withdrawReward: '0.002',
      withdrawCommission: '0.002',
      modifyWithdrawAddress: '0.002',
    },
    gas: {
      default: '600000',
      delegate: '600000',
  ...
  [CHAIN.PROVENANCE]: {
    ...
    fee: {
      ...
      withdraw: '1.2',
      withdrawReward: '1.2',
      withdrawCommission: '1.2',
      modifyWithdrawAddress: '1.2',
    },
    gas: {
      default: '600000',
      delegate: '600000',
  ...
  [CHAIN.LIKE_COIN]: {
    ...
    fee: {
      ...
      withdraw: '0.05',
      withdrawReward: '0.05',
      withdrawCommission: '0.053',
      modifyWithdrawAddress: '0.053',
    },
    gas: {
      default: '600000',
      delegate: '600000',
  ...
  [CHAIN.KUJIRA]: {
    ...
    fee: {
      ...
      redelegate: '0.012',
      withdraw: '0.008',
      withdrawReward: '0.008',
      withdrawCommission: '0.008',
      modifyWithdrawAddress: '0.008',
    },
    gas: {
      default: '1000000',
      delegate: '1000000',
      ...
      redelegate: '1600000',
      withdraw: '1000000',
      withdrawReward: '1000000',
      withdrawCommission: '1000000',
      modifyWithdrawAddress: '1000000',
    },
  },
  [CHAIN.TERITORI]: {
    chainId: 'teritori-1',
  ...
  [CHAIN.QUICK_SILVER]: {
    ...
    fee: {
      ...
      redelegate: '0.0009',
      withdraw: '0.0006',
      withdrawReward: '0.0008',
      withdrawCommission: '0.0008',
      modifyWithdrawAddress: '0.0008',
    },
    gas: {
      default: '400000',
      delegate: '500000',
  ...
  [CHAIN.COREUM]: {
    ...
    name: 'Coreum',
    extensionId: 'coreum',
    extensionCoinType: '990',
    path: CHAIN.COREUM,
    imgURL: `${baseURL}/coreum.png`,
    wallet: {
      hdPath: '44/990/0/0/0',
      prefix: 'core',
      support: { ledger: false, keystation: false, extension: true },
  ...
  [CHAIN.KYVE]: {
    ...
    fee: {
      ...
      withdraw: '0.06',
      withdrawReward: '0.06',
      withdrawCommission: '0.06',
      modifyWithdrawAddress: '0.06',
    },
    gas: {
      default: '600000',
      delegate: '600000',
  ...
  [CHAIN.ARCHWAY]: {
    ...
    decimal: 18,
    coingeckoId: 'tmp',
    validatorIconDirectory: 'archway',
    mintscanPath: 'archway',
    fee: {
      default: '0.2',
      delegate: '0.3',
      undelegate: '0.3',
  ...
  [CHAIN.CELESTIA]: {
    chainId: 'celestia',
    name: 'Celestia',
    extensionId: 'celestia',
    extensionCoinType: '118',
    path: CHAIN.CELESTIA,
    imgURL: `${baseURL}/celestia.png`,
    wallet: {
      hdPath: '44/118/0/0/0',
      prefix: 'celestia',
      support: { ledger: true, keystation: false, extension: true },
    ...
    validatorIconDirectory: 'celestia',
    mintscanPath: 'celestia',
    fee: {
      default: '0.02',
      delegate: '0.02',
      undelegate: '0.02',
