...
export class QueryNFTsOfClassRequest extends jspb.Message {
  getClassId(): string;
  setClassId(value: string): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): QueryNFTsOfClassRequest.AsObject;
  static toObject(includeInstance: boolean, msg: QueryNFTsOfClassRequest): QueryNFTsOfClassRequest.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: QueryNFTsOfClassRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): QueryNFTsOfClassRequest;
  static deserializeBinaryFromReader(message: QueryNFTsOfClassRequest, reader: jspb.BinaryReader): QueryNFTsOfClassRequest;
}

export namespace QueryNFTsOfClassRequest {
  export type AsObject = {
    classId: string,
    owner: string,
...
export class QueryNFTsOfClassResponse extends jspb.Message {
  clearNftsList(): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): QueryNFTsOfClassResponse.AsObject;
  static toObject(includeInstance: boolean, msg: QueryNFTsOfClassResponse): QueryNFTsOfClassResponse.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: QueryNFTsOfClassResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): QueryNFTsOfClassResponse;
  static deserializeBinaryFromReader(message: QueryNFTsOfClassResponse, reader: jspb.BinaryReader): QueryNFTsOfClassResponse;
}

export namespace QueryNFTsOfClassResponse {
  export type AsObject = {
